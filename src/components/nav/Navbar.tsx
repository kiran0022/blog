...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between">
      <Link href={"/"}>
        <h2 className="  group bg-gradient-to-r from-slate-100 to-violet-600  bg-clip-text text-3xl font-bold text-transparent">
          <p className="flex items-end ">
            N
            <RxCrumpledPaper className="mr-2 rotate-3 pb-1 pr-1 text-2xl font-bold text-white" />{" "}
            idea?
          </p>
